...
class Adapter_Bank( images_c : Array<String>, names_C : Array<String>,context1 : Context) : RecyclerView.Adapter<Adapter_Bank.abc>() {
  ...
  init {
    ...
    override fun onBindViewHolder(holder: abc, position: Int) {
        ...
        holder.card.background.setTint(Color.parseColor("#0096c7"))
