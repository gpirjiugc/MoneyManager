...
class Slider3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view =  inflater.inflate(R.layout.fragment_slider3, container, false)
        imageView = view.findViewById(R.id.image_slide3_res)
        linearLayout = view.findViewById(R.id.linear_slider_text_3)
