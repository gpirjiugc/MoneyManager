...
lateinit var  linearLayout :  LinearLayout
    ...
    override fun onCreateView(
        ...
        var view =  inflater.inflate(R.layout.fragment_slider4, container, false)

        imageView = view.findViewById(R.id.image_slide4_res)
        linearLayout = view.findViewById(R.id.linear_slider_text_4)
